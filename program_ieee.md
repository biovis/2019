...
<div>
    <div class="sumTime2" style="font-size:15px;color:#21a186;">9:10 - 9:35</div>
    <div>
        <div class="sumContent" style="padding-left:120px;font-size:15px;color:#21a186;">Visual Innovations and Challenges in Drug Development</div>
          <div class="sumDetail" style="padding-left:120px;font-size:15px;color:#21a186;"><i> Speaker: <b> Martin Karpefors </b>, AstraZeneca</i> <a href = "#d_martin_abs" style ="font-size:10px;color:#21a186;"> ... [abstract & bio]</a></div> 
    </div>
</div>


<div>
    <div class="sumTime2" style="font-size:15px;color:#21a186;">9:35 - 10:05</div>
    <div>
        <div class="sumContent" style="padding-left:120px;font-size:15px;color:#21a186;">Personalized OncoGenomics: Translating Whole Cancer Genomes for the Clinic</div>
          <div class="sumDetail" style="padding-left:120px;font-size:15px;color:#21a186;"><i> Speaker: <b> Erin Pleasance</b>, British Columbia Cancer Agency</i> <a href = "#d_erin_abs" style ="font-size:10px;color:#21a186;"> ... [abstract & bio]</a></div> 
    </div>
</div>
...
<!-- DATA CONTEST : JAMES -->
 ...
 <div>
      ...
      <div class="sumDetail" style="padding-left:120px;"> <em>Presenter: Cassia Artanegara and Angus Forbes</em> </div>
  </div>
  ...
  <div>
    ...
    <div>
        ...
        <div class="sumContent" style="padding-left:120px;font-size:15px;color:#21a186;">Little table, what do you have to say of visualization?</div>
          <div class="sumDetail" style="padding-left:120px;font-size:15px;color:#21a186;"><i> Speaker: <b> Martin Krzywinski</b>, Michael Smith Genome Sciences Centre</i><a href = "#c_martin_abs" style ="font-size:10px;color:#21a186;"> ... [abstract & bio]</a></div>
    </div>
</div>
<hr>
<div>
...
<div class="talk">
   ...
   <!--  <div class="tportrait"><img src="{{ site.baseurl}}/images/speakers/gotz_david.jpg" style="width: 150px;" alt="David Gotz"></div> -->
    ...
    <div class="tabstract" id="d_martin_bio"><b>Speaker Bio:</b>
...
<div class="talk">
   ...
   <!--  <div class="tportrait"><img src="{{ site.baseurl}}/images/speakers/gotz_david.jpg" style="width: 150px;" alt="David Gotz"></div> -->
    ...
    <div class="tabstract" id="d_sean_bio"><b>Speaker Bio:</b>
...
<div class="talk">
   ...
   <!--  <div class="tportrait"><img src="{{ site.baseurl}}/images/speakers/gotz_david.jpg" style="width: 150px;" alt="David Gotz"></div> -->
    ...
    <div class="tbioabstract">
      ...
      <div class="tabstract" id = "d_erin_abs"><b>Abstract:</b>
